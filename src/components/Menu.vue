    ...
    >
      <v-list dense nav class="py-0">
        ...
        <v-list-group v-if="aplications.PARAMETRIZACION">
          ...
          <v-list-item
            v-if="screen.CLASIFICACION.ver"
            :to="{ name: 'Clasificacion' }"
          >
            <v-list-item-icon>
          ...
          <v-list-item
            v-if="screen.LINEA.ver"
            :to="{ name: 'Lineaprogramatica' }"
          >
            <v-list-item-icon>
          ...
          <v-list-item
            v-if="screen.PERIODICIDAD.ver"
            :to="{ name: 'Periodicidad' }"
          >
            <v-list-item-icon>
        ...
        <v-list-group v-if="aplications.INDICADORES">
          ...
          <v-list-item
            v-if="screen.ADMININDICADORES.ver"
            :to="{ name: 'AdministradorDeIndicadores' }"
          >
            <v-list-item-icon>
            ...
            <v-list-item-content>
              <v-list-item-title
                >Administrador de Indicadores</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-list-group>
        <v-list-group v-if="aplications.METAS">
          ...
          <v-list-item
            v-if="screen.METASLINEA.ver"
            :to="{ name: 'MetaEsperadaEnLinea' }"
          >
            <v-list-item-icon>
              <v-icon>mdi-comment-account</v-icon>
            </v-list-item-icon>
        ...
        <v-list-group v-if="aplications.INDICADORES">
          ...
          <v-list-item
            v-if="screen.CONFIGURAR.ver"
            :to="{ name: 'ConfigPermisos' }"
          >
            <v-list-item-icon>
          ...
          <v-list-item
            v-if="screen.APLICACIONES.ver"
            :to="{ name: 'Aplicaciones' }"
          >
            <v-list-item-icon>
        ...
        <v-list-group v-if="aplications.EVENTOS">
          ...
          <v-list-item
            v-if="screen.GESTIONEVENTOS.ver"
            :to="{ name: 'Eventos' }"
          >
            <v-list-item-icon>
          ...
          <v-list-item
            v-if="screen.CATEVENTOS.ver"
            :to="{ name: 'CategoriaEventos' }"
          >
            <v-list-item-icon>
        ...
        <v-list-group v-if="aplications.SERVICIOSTECNOLOGICOS">
          ...
          <v-list-item
            v-if="screen.METASERVICIOSTECNOLOGICOS.ver"
            :to="{ name: 'Tecnologicos' }"
          >
            <v-list-item-icon>
          ...
          <v-list-item
            v-if="screen.REPORTESMETASSERVICIOSTECNOLOGICOS.ver"
            :to="{ name: 'RepotesTecnologicos' }"
          >
            <v-list-item-icon>
