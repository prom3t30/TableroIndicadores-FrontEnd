            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn
                  ...
                  >No</v-btn
                >
                <v-btn color="danger darken-1" text @click="deleteItem"
                  >Si</v-btn
                >
              </v-card-actions>
            </v-card>
            ...
            <v-dialog v-model="dialog" max-width="500px">
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-bind="attrs"
                  v-on="on"
                  >Nueva Línea programática</v-btn
                >
                <v-btn
                  color="warning"
                  dark
                    ...
                    <v-row>
                      <v-col cols="12" sm="12" md="12">
                        <v-select
                          :items = "responsable"
                          :rules = "[
                            (v) => !!v || 'Debe seleccionar un responsable',
                          ]"
                          label="Responsable línea"
                          v-model="editedItem.ResponsableLinea"
                          required
                        ></v-select>
                      </v-col>
                    </v-row>
  ...
  computed: {
    ...
    formTitle() {
      return this.editedIndex === -1
        ? "Nueva linea programatica"
        : "Editar línea programatica";
    },
    disabled() {
  ...
  methods: {
    ...
    deleteItem() {
      ...
      if (this.parametros.splice(index, 1)) {
        axios
          .delete(
            this.$api + this.$lineaprogramatica + "/" + this.deletedItem.id
          )
          .then((response) => {
